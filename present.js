...
function init() {
  ...
  document.querySelector('#card1 .title-card').innerHTML = `💘${titleCard}💘`;
  //document.querySelector('#card1 .content-card').innerHTML = `${contentCard}`;
  ...
  // present1.addEventListener("click", function(e){
